...
void set_nagle(int sock, int flag) {
	setsockopt(sock, IPPROTO_TCP, TCP_NODELAY, (char*)&flag, sizeof(int));  //IPPROTO_TCP indica que la opcion sea
                                                                           //interpretada por TCP; esto es para 
                                                                          //indicar mas niveles (SOL_SOCKET)
                                                                          //TCP_NODELAY deshabilita el algoritmo Nagle's
}
